  ...
  return (
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/cynegeticus" title="Cynegeticus" />
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/silk" title="Silk" />
      </nav>
      <nav
