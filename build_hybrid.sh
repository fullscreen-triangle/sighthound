...
echo ""
echo "🚀 Next steps:"
echo "1. Test your system: python3 detect_performance.py"
echo "2. Run your existing code - it will automatically use Rust when available"
echo "3. Check performance: from core.hybrid_bridge import get_performance_mode; print(get_performance_mode())"
echo ""
